...
var dbQuery = 'MATCH (n:Article)-[l:ConnectsTo*1..2]->(o:Article) WHERE n.' + titleVar + ' = "' + article + '" RETURN n,l,o';
...
//        } 
    ...
    for(var i = 0; i < textSorted.length; i++) {
        ...
        console.log(textSorted[i]);
        textBuffer += textSorted[i][0] + " - " + textSorted[i][1] + "\r\n";
    }  
